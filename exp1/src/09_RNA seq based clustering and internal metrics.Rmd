...
```{r}
part_clust = readRDS(file = file.path(config$clustering_after_m3c$intMetricsDir,
                                          "partitioning clustering objects.rds")) 
...
saveRDS(part_clust, file = file.path(config$clustering_after_m3c$intMetricsDir, "partitioning clustering objects.rds"))
part_res %>% write.xlsx(file.path(config$clustering_after_m3c$intMetricsDir, "partitioning clustering results.xlsx"))
```
...
saveRDS(h_clust, file = file.path(config$clustering_after_m3c$intMetricsDir, "hierarchical or agglomerative clustering objects.rds"))
h_clust_res = h_clust_res %>% reduce(bind_rows)
h_clust_res  %>% write.xlsx(file.path(config$clustering_after_m3c$intMetricsDir, "hierarchical or agglomerative clustering results.xlsx"))
```
...
```{r fitting}
h_kmeans_clust = readRDS(file = file.path(config$clustering_after_m3c$intMetricsDir,
                                          "hierarchical kmeans with agglomerative clustering objects.rds"))  
...
for (i in 1:length(h_kmeans_clust)) {
  for (ii in 1:length(h_kmeans_clust)) {
    print(paste(hc.metric[i],hc.method[ii]))
...
saveRDS(h_kmeans_clust, file = file.path(config$clustering_after_m3c$intMetricsDir, 
                                         "hierarchical kmeans with agglomerative clustering objects.rds"))
h_kmeans_res %>% write.xlsx(file.path(config$clustering_after_m3c$intMetricsDir,
                                      "hierarchical kmeans with agglomerative clustering results.xlsx"))
```
...
```{r}
fuzzy_clust = readRDS(file = file.path(config$clustering_after_m3c$intMetricsDir, "fuzzy clustering objects.rds")) 
...
saveRDS(fuzzy_clust, file = file.path(config$clustering_after_m3c$intMetricsDir, "fuzzy clustering objects.rds"))
fuzzy_res %>% write.xlsx(file.path(config$clustering_after_m3c$intMetricsDir, "fuzzy clustering results.xlsx"))
```

### model based (Gaussian Mixture Models)

```{r}
model_based_clust = readRDS(file = file.path(config$clustering_after_m3c$intMetricsDir, "model based gaussian mixture model object.rds"))
...
saveRDS(model_based_clust, file = file.path(config$clustering_after_m3c$intMetricsDir, "model based gaussian mixture model object.rds"))
model_based_res %>% write.xlsx(file.path(config$clustering_after_m3c$intMetricsDir, "model based guassian mixture model results.xlsx"))
```
